...
#define STRING_CONFIG_H_AUTHOR "(alrtprogrammer, Ender-3)" // Who made the changes.
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  37.29
    #define DEFAULT_Ki   4.91
    #define DEFAULT_Kd  70.84
  #endif
#else
 ...
 */
  ...
  #define MPC_BLOCK_HEAT_CAPACITY { 13.05f }           // (J/K) Heat block heat capacities.
  #define MPC_SENSOR_RESPONSIVENESS { 0.1930f }         // (K/s per ∆K) Rate of change of sensor temperature from heat block.
  #define MPC_AMBIENT_XFER_COEFF { 0.0872f }           // (W/K) Heat transfer coefficients from heat block to room air with fan off.
  #if ENABLED(MPC_INCLUDE_FAN)
    #define MPC_AMBIENT_XFER_COEFF_FAN255 { 0.1046f }  // (W/K) Heat transfer coefficients from heat block to room air with fan on full.
  #endif
...
//#define PIDTEMPBED
  ...
  #define DEFAULT_bedKp 186.00
  #define DEFAULT_bedKi  35.23
  #define DEFAULT_bedKd 654.73
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 79.43, 79.43, 400, 139 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 500, 500, 20, 200 }
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3500, 3500, 100, 5000 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -38, 6, -1.30 }
...
#define SKEW_CORRECTION
  ...
  #define XY_DIAG_AC 141.40
  #define XY_DIAG_BD 140.65
  #define XY_SIDE_AD  99.55
