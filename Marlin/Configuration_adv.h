...
//
  ...
  #define CHAMBER_PULLUP_RESISTOR_OHMS 10000 // Pullup resistor
...
//
  ...
  //#define HEATER_CHAMBER_PIN      PC13   // Required heater on/off pin (example: SKR 1.4 Turbo HE1 plug)
...
#define FAN_KICKSTART_POWER 64  // 64-255
...
#define INPUT_SHAPING_Y
    ...
    #define SHAPING_FREQ_X  35.76          // (Hz) The default dominant resonant frequency on the X axis.
    #define SHAPING_ZETA_X  0.15f       // Damping ratio of the X axis (range: 0.0 = no damping to 1.0 = critical damping).
  #endif
  #if ENABLED(INPUT_SHAPING_Y)
    #define SHAPING_FREQ_Y  41.97          // (Hz) The default dominant resonant frequency on the Y axis.
